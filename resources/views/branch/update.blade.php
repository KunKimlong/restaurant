<form action="{{ Route('branch.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col-6 my-2">
            ...
            <input type="text" name="name" value="{{$branch->name}}" id="name" placeholder="Name" class="form-control">
        </div>
        <div class="col-6 my-2">
        ...
        <div class="col-12 my-2">
            ...
            <div class="p-2 border border-1" style="width: fit-content !important;cursor: pointer;">
