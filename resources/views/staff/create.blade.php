...
@section('page-title')
    <div class="card card-rounded">
        <div class="card-header p-3">
            <h5 class="m-0">Create new staff</h5>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="card rounded rounded-5">
        <div class="card-header d-flex justify-between p-3">
            <div class="card-title">Creating Staff</div>
        </div>
        <div class="card-body">
            <form action="{{ Route('staff.store') }}" class="col-11 mx-auto" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-6 my-1">
                        ...
                        <div class="form-group p-0">
                            <input type="radio" name="gender" id="male" class="" value="Male"> <label
                                for="male">Male</label>
                            <input type="radio" name="gender" id="female" class="mx-2" value="Female"> <label
                    ...
                    <div class="col-6 my-1">
                        ...
                        <select name="position" id="position" class="form-control">
                            ...
                            @forelse ($positions as $position => $value)
                                <option value="{{ $position }}">{{ $value }}</option>
                            @empty
                    ...
                    <div class="col-6 my-1">
                        ...
                        <select name="branch" id="branch" class="form-control">
                            ...
                            @forelse ($branches as $branch => $value)
                                <option value="{{ $branch }}">Resturant {{ convertToRoman($value) }}</option>
                            @empty
                    ...
                    <div class="col-12 my-1">
                        ...
                        <textarea name="address" id="" rows="5" style="resize: none" class="form-control"></textarea>
                    </div>
                    <div class="col-12">
